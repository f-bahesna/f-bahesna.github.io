<template>
  <div class="container mx-auto py-5 flex justify-center w-full px-5 min-h-screen border-2 bg-slate-400 mb-7">
    <div class="space-y-6">
        ...
        <div class="mb-8">
          <div class="text-gray-700 text-md text-wrap font-sans">Hi I'm Frada Software Engineer from Indonesia.
            <p class="indent-8 font-sans">I began my career as a Backend Software Engineer at a fintech startup in
              ...
              and
              features using Laravel, Jquery and PostgreSQL, collaborate with product managers and connecting data from
              our
              Core API.
              <br />
            </p>
            <p class="indent-8 font-sans">
              ...
              about
              clean code, design patterns, and how to make systems more efficient and scalable.
              <br />
              I'm passionate about Fullstack Web Development, Microservices, Domain-Driven Design (DDD), and Software
              Design Systems.
            </p>
            <br />
